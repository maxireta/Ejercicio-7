...
class lista(interfaz):
    ...
    def creardocente(self, mos):
        ...
        cargo = mos["cargo"]
        catedra = mos["catedra"]
        doc = docente(cuil, apellido, nombre, sueldo, antiguedad, carrera, cargo, catedra, 0, 0)
    ...
    def creardocenteinv(self, mos):
        ...
        docinv = docenteinvestigador(cuil, apellido, nombre, sueldo, antiguedad, carrera, cargo, catedra, categoria, importe, area, tipo)
